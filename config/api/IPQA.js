...
const IPQA = {
    ...
    getExcReportData: base.proxy + 'IPQA/GetExcReportData?problemStatus={problemStatus}&empno={empno}&type={type}&company_name={company_name}&skipRows={skipRows}&pageSize={pageSize}&boss_empno={boss_empno}&qa_empno={qa_empno}&closer_empno={closer_empno}',
