...
module.exports = {
    search: ({
        ...
        return db.execute(`select * from ${tableName} where DELETE_FLAG <> 'Y' or DELETE_FLAG is null and line_id = NVL(${line_id},line_id) ORDER BY CREATION_DATE`).then((res) => res.rows)
    },
